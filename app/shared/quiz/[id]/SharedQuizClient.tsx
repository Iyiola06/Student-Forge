                                ...
                                return (
                                    ...
                                    >
                                        <div className="flex items-start gap-3">
                                            <div className={\`shrink-0 mt-0.5 size-6 rounded-full border-2 flex items-center justify-center text-xs font-bold \${
                                                !showExplanation && isSelected ? 'border-[#ea580c] bg-[#ea580c] text-white' :

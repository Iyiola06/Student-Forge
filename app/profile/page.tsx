        ...
        <main className="flex flex-1 flex-col px-4 sm:px-10 py-8 max-w-[1440px] mx-auto w-full">
          ...
          <div className="bg-[#101022]/60 backdrop-blur-xl rounded-[2rem] border border-[#2d2d3f] overflow-hidden mb-8 shadow-2xl relative">
            ...
            <div className="px-10 pb-10">
              <div className="relative flex flex-col md:flex-row justify-between items-center md:items-end -mt-16 md:-mt-12 mb-6 gap-4">
                ...
                <Link href="/settings">
                  <button className="px-6 py-2.5 bg-white dark:bg-[#252535] border border-slate-200 dark:border-[#3b3b54] rounded-xl text-sm font-bold text-slate-700 dark:text-white hover:bg-slate-50 dark:hover:bg-[#2d2d3f] transition-all shadow-sm active:scale-95">
                    Edit Profile
                  </button>
                </Link>
              </div>

                ...
                >
                    ...
                    <div className="prose prose-slate dark:prose-invert max-w-none space-y-6">
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-[#ea580c]">1. Information We Collect</h2>
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-[#ea580c]">2. How We Use Information</h2>
                            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-[#ea580c]">3. Data Sharing and Disclosure</h2>
                            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-[#ea580c]">4. AI Data Processing</h2>
                            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-[#ea580c]">5. Data Security</h2>
                            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">
                        ...
                        <section className="space-y-4">
                            <h2 className="text-2xl font-bold text-[#ea580c]">6. Your Rights</h2>
                            <p className="text-slate-600 dark:text-slate-300 leading-relaxed">

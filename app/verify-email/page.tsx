      ...
      <div className="layout-container flex h-full grow flex-col">
        ...
        <main className="flex flex-1 flex-col items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
          <div className="w-full max-w-md space-y-8 bg-white dark:bg-[#1b1b27] p-8 rounded-2xl shadow-xl ring-1 ring-slate-900/5 dark:ring-white/10 text-center">
            {/* Icon */}
            <div className="mx-auto flex h-24 w-24 items-center justify-center rounded-full bg-[#2525f4]/10 dark:bg-[#2525f4]/20 mb-6 animate-bounce">
              <span className="material-symbols-outlined text-[#2525f4] text-5xl">
                mark_email_unread
              </span>
            </div>
            {/* Text */}
            ...
            <div className="pt-4">
              ...
              <button
                className="w-full rounded-lg border border-slate-300 dark:border-[#3b3b54] bg-white dark:bg-[#252535] px-4 py-3 text-sm font-semibold text-slate-700 dark:text-white shadow-sm hover:bg-slate-50 dark:hover:bg-[#2d2d3f] focus:outline-none focus:ring-2 focus:ring-[#2525f4] focus:ring-offset-2 transition-all"
                type="button"
              >
                Resend Email (00:59)
              </button>
            ...
            <div className="pt-2">
              <Link
                className="text-sm font-medium text-[#2525f4] hover:text-[#2525f4]/80 transition-colors flex items-center justify-center gap-2"
                href="/login"
              >
